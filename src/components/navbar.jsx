      ...
      <nav style={{ backgroundColor: "#F4EAE1", filter: 'blur(0.0px)' }} className="bg-white border-gray-200 md:text-2xl sm:text-xl dark:bg-white-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <div className='flex md:ml-5 ml-0 justify-center items-center'>
            ...
            <h1 onClick={togglePopup} style={{ backgroundColor: "#F4EAE1", filter: 'blur(0.7px)' }} className="text-4xl p-3 text-gray-700 font-bold">kunalwhatt</h1> 
          </div>
            ...
            <ul className="PP flex flex-col p-6 md:p-0 mt-4 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-white-800 md:dark:bg-white-900  dark:border-gray-700">
              ...
              <li>
                <a
                  ...
                  href="https://app.rezi.ai/s/YwTlzg4qN8S03mnnD5wB"
      ...
      {isPopupOpen && (
        <div style={{ backgroundColor: "#F4EAE1", filter: 'blur(0.6px)' }} ref={popupRef} className="pfp-dropdown md:ml-20  -mt-1">
          <ul>
            ...
            <li>
              <a href="https://github.com/kunalwhatt" target="_blank" rel="noopener noreferrer">
                <div className='flex justify-start ml-5 items-center'>
                    <FaGithub /> &nbsp; @kunalwhatt &nbsp; <HiOutlineArrowUpRight />
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.linkedin.com/in/kunalwhatt/" target="_blank" rel="noopener noreferrer">
                <div className='flex justify-start ml-5 items-center'>
                <SiLinkedin /> &nbsp; @kunalwhatt &nbsp; <HiOutlineArrowUpRight />
                </div>
              </a>
            </li>
            <li>
              <a href="mailto:imkunal31india@gmail.com" target="_blank" rel="noopener noreferrer">
                <div className='flex justify-start ml-5 items-center'>
                <CgMail />   &nbsp; imkunal31india@gmail.com &nbsp; <HiOutlineArrowUpRight />
                </div>
              </a>
            </li>
            <li>
              <a href="https://www.instagram.com/kunalwhatt/" target="_blank" rel="noopener noreferrer">
                <div className='flex justify-start ml-5 items-center'>
                  <GrInstagram /> &nbsp; @kunalwhatt &nbsp; <HiOutlineArrowUpRight />
                </div>
              </a>
            </li>
            <li>
              <a href="https://wa.me/+918142180305" target="_blank" rel="noopener noreferrer">
                <div className='flex justify-start ml-5 items-center'>
                <FaWhatsapp />  &nbsp; WhatsApp &nbsp; <HiOutlineArrowUpRight />
                </div>
              </a>
            </li>
            <li>
              <a href="https://twitter.com/kunalwhatt" target="_blank" rel="noopener noreferrer">
                <div className='flex justify-start ml-5 items-center'>
                <BsTwitterX />  &nbsp; @kunalwhatt &nbsp; <HiOutlineArrowUpRight />
                </div>
              </a>
            </li>
