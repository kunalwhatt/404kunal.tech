...
function AboutMe() {
  ...
  <div className='w-1/5 h-1/5 md:w-1/6 md:h-1/6 sm:blur-[70px] md:blur-[140px]' style={{ position: 'absolute', left: '30%', zIndex: 0, background: `linear-gradient(90deg, ${gradientColors[2][0]} 100%, ${gradientColors[0][0]} 100%)`, borderRadius: 400, animation: 'slideLeft 3s linear infinite' }} />
      ...
      <div className='flex  justify-center   pt-28 md:pt-40'  style={{ zIndex: 10, color: 'rgba(105, 111, 77, 0.80)', fontSize: 50, fontFamily: 'Inknut Antiqua', fontWeight: '100', lineHeight: 1.3, wordWrap: 'break-word' }}>KUNAL <br />KUMAR DAPPU<br /> "ज़िन्दगी ज़िंदाबाद " <br />"l'art du <br />CODE" </div>
