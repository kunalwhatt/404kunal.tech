...
function Contact() {
  ...
  const glitch = useGlitch({ pulse: { scale: 2 } });

  const sendEmail = (e) => {
    e.preventDefault();
    console.log('sendEmail called'); // Debug log
    setLoading(true);
        ...
        <div id='getintouch' className='pirateone' style={{ backgroundColor: "#F4EAE1" }}>
          <div className='md:flex sm:pt-20'>
            <div className='md:w-1/2'>
              <img ref={glitch.ref} src={Cat} alt="catglitch" className='md:w-full' />
            </div>
            ...
            <div className='md:w-1/2 mt-6 md:mr-40 text-4xl sm:ml-10 sm:mr-10 sm:mt-0'>
              ...
              <div className='text-pink-300 pb-10 text-center text-2xl mt-2'> made with {hi} by kunal </div>
            </div>
          </div>
        </div>
      </div>
